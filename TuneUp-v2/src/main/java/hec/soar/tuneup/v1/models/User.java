...
public class User {
    ...
    //// METTRE A JOUR LE CONSTRUCTEUR pour la photo
    ...
    public int calculateAge2() {
        // much better. calculuate age on object without params
        LocalDate now = LocalDate.now();
        LocalDate birthDate = this.date_of_birth;
        if ((birthDate != null) ) {
