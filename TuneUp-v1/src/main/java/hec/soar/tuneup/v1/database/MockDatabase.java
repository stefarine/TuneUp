...
public class MockDatabase {
    ...
    // TABLE USER
    users = new HashMap();
    users.put("user1@unil.ch", new User("user1@unil.ch","www.instagram.com/user1","myNameU1",
            LocalDate.of(1996,12,6),"myPassword","i am user1"));
    users.put("user2@unil.ch", new User("user2@unil.ch","www.instagram.com/user2","myNameU2",
            LocalDate.of(1983,11,26),"myPassword123","i am user2 and i like cheese"));
    users.put("user3@unil.ch", new User("user3@unil.ch","www.instagram.com/user3","myNameU3",
            LocalDate.of(1992,12,6),"myPasswordblabla","i am user3 the paprika"));
    users.put("user4@unil.ch", new User("user4@unil.ch","www.instagram.com/user4","myNameU4",
            LocalDate.of(2001,1,4),"myPass","i am user4 the real one"));   
