...
public class MockDatabase {
    ...
    private Map<Users, ArrayList<Track>> inThePlaylist;
    ...
    // TABLE USER
    users = new HashMap();
    users.put("user1@unil.ch", new Users("user1@unil.ch","www.instagram.com/user1","Pedro",
            new Date(1997,06,07),"myPassword","i am user1. I like cheese. My favorite dish is cheese fondue. My favorite cheese is Gruyere. My favorite animal is cheese."
            ,"https://i.ibb.co/Kmgwh82/pexels-elle-hughes-1680172.jpg"));
    users.put("user2@unil.ch", new Users("user2@unil.ch","www.instagram.com/user2","Jerome",
            new Date(1997,06,07),"myPassword123","i am user2 and i like cheese"
            ,"https://i.ibb.co/Kmgwh82/pexels-elle-hughes-1680172.jpg"));
    users.put("user3@unil.ch", new Users("user3@unil.ch","www.instagram.com/user3","Andrea",
            new Date(1997,06,07),"myPasswordblabla","I like cats. I hate dogs. I wich i could be a cat in a cat’s world."
            ,"https://i.ibb.co/Y8jJM1Z/pexels-andrea-piacquadio-774866.jpg"));
    users.put("user4@unil.ch", new Users("user4@unil.ch","www.instagram.com/user4","Barnabé",
            new Date(1997,06,07),"myPass","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
    ...
    public Map<Users, ArrayList<Track>> getInThePlaylist(){
        return inThePlaylist;
    }
    
    public Map<Users, ArrayList<Users>> getLikeUser(){
        return likeUser;
    }
    ...
    public void createPlayList(Users u){
        inThePlaylist.put(u, new ArrayList<>());
    }
    
    public void createLikeList(Users u){
        likeUser.put(u, new ArrayList<>());
    }
    
    // add or remove a track from the playlist
    public void userLikeTrack(Users user,Track track ){
        inThePlaylist.get(user).add(track);
    }
    
    public void userDeleteTrack(Users user, Track track){
        inThePlaylist.get(user).remove(track);
    }
    
    // like or unlike a user
    public void userLikeUser(Users mainUser, Users likedUser){
        likeUser.get(mainUser).add(likedUser);
    }
    
    public void userDeleteLikedUser(Users mainUser, Users likedUser){
        likeUser.get(mainUser).remove(likedUser);
    }
    
    // Update User's Profile
    public void updateSocialMediaLink(Users user, String socialMedia_link){
        user.setSocialMedialink(socialMedia_link);
    }
    
    public void updateFirstName(Users user, String first_name){
        user.setFirstName(first_name);
    }
    
    public void updateDateOfBirth(Users user, Date date){
    ...
    public void updateDescription(Users user, String description){
